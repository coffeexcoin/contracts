...
contract KerosineDeployBase is Script {
    ...
    function deploy(address _owner, ERC20 _stakingToken1, VaultManager _vaultManager, Dyad _dyad)
        public
        returns (Kerosine, KerosineManager, Staking, UnboundedKerosineVault, BoundedKerosineVault)
    {
        ...
        UnboundedKerosineVault unboundedKerosineVault =
            new UnboundedKerosineVault(_vaultManager, kerosine, _dyad, kerosineManager);

        // IMPORTANT: Vault needs to be licensed!
        BoundedKerosineVault boundedKerosineVault =
            new BoundedKerosineVault(_vaultManager, kerosine, _dyad, kerosineManager);

        boundedKerosineVault.setUnboundedKerosineVault(unboundedKerosineVault);

        KerosineDenominator _kerosineDenominator = new KerosineDenominator(boundedKerosineVault);

        unboundedKerosineVault.setDenominator(_kerosineDenominator);

        return (kerosine, kerosineManager, staking, unboundedKerosineVault, boundedKerosineVault);
    }
}
