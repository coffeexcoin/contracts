...
contract DeployV2 is Script, Parameters {
    function run() public {
        ...
        VaultManager vaultManager = new VaultManager(DNft(MAINNET_DNFT), Dyad(MAINNET_DYAD), Licenser(vaultLicenser));

        // weth vault
        Vault vault = new Vault(vaultManager, ERC20(MAINNET_WETH), IAggregatorV3(MAINNET_WETH_ORACLE));
        ...
        Payments payments = new Payments(vaultManager, IWETH(MAINNET_WETH));
